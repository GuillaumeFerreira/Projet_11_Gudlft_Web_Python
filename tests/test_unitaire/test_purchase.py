...
class TestPurchase:
    ...
    def test_purchasePlacesMore(self,client, load_clubs_fixture, load_competitions_fixture):
    ...
    def test_purchasePlaces(self,client, load_clubs_fixture, load_competitions_fixture):
        response = client.post(
            "/showSummary",
            data={"email": "admin@irontemple.com"}, follow_redirects=True
        )
    ...
    def test_purchasePlacesTwelve(self,client, load_clubs_fixture, load_competitions_fixture):
        response = client.post(
            "/showSummary",
            data={"email": "admin@irontemple.com"}, follow_redirects=True
        )
    ...
    def test_purchasePlacesCompetition(self,client, load_clubs_fixture, load_competitions_fixture):
        response = client.post(
            "/showSummary",
            data={"email": "admin@irontemple.com"}, follow_redirects=True
        )
    ...
    def test_purchaseDate_valid(self,client, load_clubs_fixture, load_competitions_fixture):
        response = client.post(
            "/showSummary",
            data={"email": "admin@irontemple.com"}, follow_redirects=True
        )
    ...
    def test_purchaseDate_not_valid(self,client, load_clubs_fixture, load_competitions_fixture):
        response = client.post(
            "/showSummary",
            data={"email": "admin@irontemple.com"}, follow_redirects=True
        )
    ...
    def test_updates_purchasePlaces(self,client, load_clubs_fixture, load_competitions_fixture):
        response = client.post(
            "/showSummary",
            data={"email": "admin@irontemple.com"}, follow_redirects=True
        )
